...
- [ ] 1. 冻结 `AutopilotRightRailProps` 类型契约与子阶段枚举
...
- [ ] 2.1 **[PBT]** 属性测试 P1：resolver total function
...
- [ ] 2.2 **[PBT]** 属性测试 P2：子阶段随 job.stage 单调推进
...
- [ ] 2.3 **[PBT]** 属性测试 P3：resolver idempotence
...
- [ ] 3. 创建 `<AutopilotRightRail>` 最小 scaffolding 组件
...
- [ ] 5. 在 `AutopilotRoutePage` 中引用 scaffolding（编译验证，不接管渲染）
