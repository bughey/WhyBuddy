...
const FALLBACK_STAGE_COLOR = FUTURE_OFFICE_COLORS.cyan;
...
export const SCENE_STAGE_SEMANTIC_COLORS: Record<
  ...
  string
> = {
  direction: FUTURE_OFFICE_COLORS.cyan,
  planning: FUTURE_OFFICE_COLORS.blue,
  execution: FUTURE_OFFICE_COLORS.mint,
  review: FUTURE_OFFICE_COLORS.violet,
  meta_audit: "#818CF8",
  revision: "#EF4444",
  verify: FUTURE_OFFICE_COLORS.mint,
  summary: FUTURE_OFFICE_COLORS.warning,
  feedback: FUTURE_OFFICE_COLORS.green,
  evolution: FUTURE_OFFICE_COLORS.rose,
};
